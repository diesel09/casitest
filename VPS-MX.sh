...
casitafree="kalix1="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2RpZXNlbDA5L2djYXBpdGFsL21haW4vTW9kdWxvcw=="
FREE='base64 -d'
...
clear
msg -bar2
msg -ama "     [ VPS - MX - SCRIPT \033[1;97m MOD By VPSMX \033[1;33m ]"
msg -bar
echo -e "\033[97m"
...
wget --no-check-certificate -O ${SCPinstal}/${arqx} ${REQUEST}/${arqx} > /dev/null 2>&1 ||
